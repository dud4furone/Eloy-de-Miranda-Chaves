...
var EmbedOptions = {
  init: function (formID, formStyle, developer, isSmartEmbed, companyDomain) {
    this.formID = formID;
    ...
    if (typeof companyDomain === 'string' && companyDomain.length > 0) {
      this.baseURL = 'https://' + companyDomain + '/';
    }

    this.formStyle = formStyle && formStyle[this.embedURLHash] ? formStyle[this.embedURLHash] : {};
...
}EmbedOptions.init(233094346057053, {"buttonBorderColor":"#bfcbd8","cardIndex-color":"#7c8d9f","pageBg-colorBegin":"#00569d","pageBg-colorEnd":"#d2d7d8","prevButtonColor":"#bfcbd8","progressActiveItemOuterCircle-bgColor":"#499fff","progressActiveItemOuterCircle-borderColor":"#fff","progressInfo-color":"#000","progressItemCircle-bgColor":"#7c8d9f","progressLine-bgColor":"#bfcbd8","progressToggleText-color":"#7c8d9f","welcome-descColor":"#1e3e66","welcome-titleColor":"#00569d","welcomeButton-bgColor":"#006eee","welcomeButton-color":"#fff","buttonBorderColor-next":"","buttonBgColor-next":"#499FFF","nextButtonColor":"#fff","pageBg-image":"","pageBg-video":"","welcomePage-bgColor":"#d2d7d8","actions-bg":"#006eee","submitButtonColor":"#ffffff","thankYou-descColor":"#1e3e66","thankYou-titleColor":"#091d35","thankYouPage-bgColor":"rgba(181,203,248,0.67)","form-fontFamily":"Fredoka One","form-externalFont":"\/\/cdn.jotfor.ms\/fonts\/?family=Fredoka+One"}, 'live', '0', '');